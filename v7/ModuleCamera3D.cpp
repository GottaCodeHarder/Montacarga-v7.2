...
{
	// Follow
	if ((App->scene_intro->timer.Chronometer(true, 2) < 5 && App->scene_intro->timer.Chronometer(true, 3) == 0) || App->input->GetKey(SDL_SCANCODE_W) == KEY_REPEAT)
		cameraDistance = { -20.0f, 500.0f, -20.0f };
	else
